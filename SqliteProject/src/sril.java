 ...
 * @author Fahim S
 */
public class sril extends javax.swing.JFrame {
    Connection conn =  null;
    ResultSet rs=null;
     PreparedStatement ps=null;
    /**
     * Creates new form sril
     */
    public sril() {
        initComponents();
    ...
    private void Table()
    {
         try{
          ...
          String s= "select * from srilanka ";
          ps=conn.prepareStatement(s);
         rs = ps.executeQuery();
          srilankatable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        srilankatable = new javax.swing.JTable();
        ...
        jButton1.setText("SRILANKA PLAYER LIST");
        getContentPane().add(jButton1);
        jButton1.setBounds(120, 20, 340, 50);
        ...
        srilankatable.setBackground(new java.awt.Color(204, 255, 204));
        srilankatable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(srilankatable);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(30, 280, 540, 234);
        ...
        jButton4.setBounds(640, 310, 110, 40);
        ...
        jButton5.setBounds(640, 370, 110, 40);

        jButton6.setBackground(new java.awt.Color(0, 255, 51));
        jButton6.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        jButton6.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fahim S\\Desktop\\JAVA\\ICC Pro\\A SAVE.png")); // NOI18N
        ...
        jButton6.setBounds(640, 190, 110, 40);

        jButton7.setBackground(new java.awt.Color(0, 255, 51));
        jButton7.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        jButton7.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fahim S\\Desktop\\JAVA\\ICC Pro\\A DELETE.png")); // NOI18N
        ...
        jLabel3.setBounds(200, 120, 80, 30);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 204, 0));
        jLabel4.setText("Rating");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(340, 120, 80, 30);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 204, 0));
        jLabel5.setText("Rank");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(480, 120, 80, 30);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fahim S\\Desktop\\JAVA\\ICC Pro\\205033.jpg")); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-10, 0, 950, 750);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
      ...
      try{
          ...
          s="Insert into srilanka values('"+a+"','"+b+"','"+c+"','"+d+"')";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
      ...
      String r= deletebox.getText();
          ...
          s="Delete from srilanka where rank='"+r+"'";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
      ...
      String u = updatebox.getText();
          s="update srilanka set Name='"+a+"',Country='"+b+"',Rating='"+c+"',Rank='"+d+"'  where Rank='"+u+"'";
          ps=conn.prepareStatement(s);
          ps.executeUpdate();
          //conn.commit();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sril.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable srilankatable;
