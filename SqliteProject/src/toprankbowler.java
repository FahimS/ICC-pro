 ...
 * @author Fahim S
 */
public class toprankbowler extends javax.swing.JFrame {
  Connection conn =  null; 
  ResultSet rs=null;
     PreparedStatement ps=null;
    /**
     * Creates new form toprankbowler
     */
    public toprankbowler() {
        initComponents();
    ...
    private void Table()
    {
         try{
          ...
          String s= "select * from bowlerrankedt20 ";
          ps=conn.prepareStatement(s);
         rs = ps.executeQuery();
          t20bowlertable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        t20bowlertable = new javax.swing.JTable();
        ...
        jButton1.setBounds(640, 180, 110, 40);
        ...
        jLabel4.setBounds(330, 130, 90, 30);
        ...
        jLabel5.setBounds(480, 130, 80, 30);
        ...
        jButton2.setBounds(640, 240, 110, 40);
        ...
        jButton3.setBounds(640, 300, 110, 40);
        ...
        searchbox.setBounds(770, 360, 100, 40);
        ...
        jButton5.setBounds(835, 463, 90, 40);

        t20bowlertable.setBackground(new java.awt.Color(204, 255, 204));
        t20bowlertable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(t20bowlertable);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(30, 260, 570, 240);
        ...
        jButton6.setBounds(830, 20, 90, 40);

        jButton7.setBackground(new java.awt.Color(255, 153, 0));
        jButton7.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jButton7.setText("T20 BOWLER RANKING");
        getContentPane().add(jButton7);
        jButton7.setBounds(100, 30, 420, 50);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fahim S\\Desktop\\JAVA\\ICC Pro\\masfrafe-bin.jpg")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      try{
          ...
          s="Insert into bowlerrankedt20 values('"+a+"','"+b+"','"+c+"','"+d+"')";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      String r= deletebox.getText();
          ...
          s="Delete from bowlerrankedt20 where rank='"+r+"'";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      String u = updatebox.getText();
          s="update bowlerrankedt20 set Name='"+a+"',Country='"+b+"',Rating='"+c+"',Rank='"+d+"'  where Rank='"+u+"'";
          ps=conn.prepareStatement(s);
          ps.executeUpdate();
          //conn.commit();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
       toprankbowler f= new toprankbowler();
       f.setVisible(true);
       this.setVisible(false); // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(toprankbowler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new toprankbowler().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable t20bowlertable;
