 ...
 * @author Fahim S
 */
public class testbowler extends javax.swing.JFrame {
    Connection conn =  null;
    ResultSet rs=null;
     PreparedStatement ps=null;
    /**
     * Creates new form testbowler
     */
    public testbowler() {
        initComponents();
    ...
    private void Table()
    {
         try{
          ...
          String s= "select * from testbowler ";
          ps=conn.prepareStatement(s);
         rs = ps.executeQuery();
          testbowlertable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        testbowlertable = new javax.swing.JTable();
        ...
        jLabel4.setBounds(340, 140, 80, 30);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 204, 0));
        jLabel5.setText("Rank");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(480, 140, 80, 30);
        ...
        jButton1.setBounds(650, 183, 110, 40);
        ...
        jButton2.setBounds(650, 253, 110, 40);
        ...
        jButton3.setBounds(650, 323, 110, 40);
        ...
        jButton5.setBounds(830, 463, 90, 40);

        testbowlertable.setBackground(new java.awt.Color(204, 255, 204));
        testbowlertable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(testbowlertable);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(20, 290, 570, 230);
        ...
        jButton6.setBounds(837, 20, 90, 40);

        jButton7.setBackground(new java.awt.Color(255, 153, 0));
        jButton7.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jButton7.setText("TEST BOWLER RANKING");
        getContentPane().add(jButton7);
        jButton7.setBounds(90, 20, 420, 50);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fahim S\\Desktop\\JAVA\\ICC Pro\\GettyImages-691085014.jpg")); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-580, 0, 1710, 1060);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      String r= deletebox.getText();
          ...
          s="Delete from testbowler where rank='"+r+"'";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      try{
          ...
          s="Insert into testbowler values('"+a+"','"+b+"','"+c+"','"+d+"')";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      String u = updatebox.getText();
          s="update testbowler set Name='"+a+"',Country='"+b+"',Rating='"+c+"',Rank='"+d+"'  where Rank='"+u+"'";
          ps=conn.prepareStatement(s);
          ps.executeUpdate();
          //conn.commit();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(testbowler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testbowler().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable testbowlertable;
