 ...
 * @author Fahim S
 */
public class india extends javax.swing.JFrame {
    ...
    private void Table()
    {
         try{
          ...
          String s= "select * from india ";
          ps=conn.prepareStatement(s);
         rs = ps.executeQuery();
          indiatable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        indiatable = new javax.swing.JTable();
        ...
        jButton1.setText("INDIA PLAYER LIST");
        ...
        indiatable.setBackground(new java.awt.Color(204, 255, 204));
        indiatable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(indiatable);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(20, 300, 540, 230);
        ...
        jButton3.setBounds(620, 270, 110, 40);
        ...
        jButton4.setBounds(620, 330, 110, 40);
        ...
        jButton5.setBounds(620, 390, 110, 40);
        ...
        jButton6.setBounds(817, 20, 90, 40);
        ...
        searchbox.setBounds(750, 390, 110, 40);

        c1.setBackground(new java.awt.Color(255, 204, 204));
        getContentPane().add(c1);
        c1.setBounds(160, 210, 110, 30);
        ...
        jLabel3.setBounds(180, 150, 80, 30);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 204, 0));
        jLabel4.setText("Rating");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(330, 150, 80, 30);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 204, 0));
        jLabel5.setText("Rank");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(470, 150, 80, 30);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fahim S\\Desktop\\JAVA\\ICC Pro\\s.jpg")); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-200, 0, 1140, 970);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
      ...
      try{
          ...
          s="Insert into india values('"+a+"','"+b+"','"+c+"','"+d+"')";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      String r= deletebox.getText();
          ...
          s="Delete from india where rank='"+r+"'";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
      ...
      String u = updatebox.getText();
          s="update india set Name='"+a+"',Country='"+b+"',Rating='"+c+"',Rank='"+d+"'  where Rank='"+u+"'";
          ps=conn.prepareStatement(s);
          ps.executeUpdate();
          //conn.commit();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(india.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable indiatable;
