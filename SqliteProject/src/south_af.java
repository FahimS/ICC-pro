 ...
 * @author Fahim S
 */
public class south_af extends javax.swing.JFrame {
    Connection conn =  null;
    ResultSet rs=null;
     PreparedStatement ps=null;
    /**
     * Creates new form south_af
     */
    public south_af() {
        initComponents();
    ...
    private void Table()
    {
         try{
          ...
          String s= "select * from south africa ";
          ps=conn.prepareStatement(s);
         rs = ps.executeQuery();
          southtable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        southtable = new javax.swing.JTable();
        ...
        jButton1.setText("SOUTH AFRICA PLAYER LIST");
        getContentPane().add(jButton1);
        jButton1.setBounds(120, 20, 400, 50);
        ...
        jButton2.setBounds(840, 470, 90, 40);

        southtable.setBackground(new java.awt.Color(204, 255, 204));
        southtable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(southtable);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(20, 270, 580, 227);
        ...
        jButton3.setBounds(660, 240, 110, 40);
        ...
        jButton4.setBounds(660, 300, 110, 40);
        ...
        jButton6.setBounds(840, 30, 90, 40);
        ...
        jLabel3.setBounds(210, 120, 60, 30);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Rating");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(350, 120, 60, 30);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Rank");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(490, 120, 60, 30);
        ...
        jButton5.setBounds(660, 360, 110, 40);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fahim S\\Desktop\\JAVA\\ICC Pro\\205055.jpg")); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, 0, 960, 830);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
      ...
      try{
          ...
          s="Insert into south africa values('"+a+"','"+b+"','"+c+"','"+d+"')";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      String r= deletebox.getText();
          ...
          s="Delete from south africa where rank='"+r+"'";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
      ...
      String u = updatebox.getText();
          s="update south africa set Name='"+a+"',Country='"+b+"',Rating='"+c+"',Rank='"+d+"'  where Rank='"+u+"'";
          ps=conn.prepareStatement(s);
          ps.executeUpdate();
          //conn.commit();
...
/// TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
     ...
     String i= searchbox.getText();
      ...
      s="select Rank from south africa";
      int flag=0;
      try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(south_af.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable southtable;
