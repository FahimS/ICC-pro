 ...
 * @author Fahim S
 */
public class eng extends javax.swing.JFrame {
    Connection conn =  null;
    ResultSet rs=null;
     PreparedStatement ps=null;
    /**
     * Creates new form eng
     */
    public eng() {
        initComponents();
    ...
    private void Table()
    {
         try{
          ...
          String s= "select * from england ";
          ps=conn.prepareStatement(s);
         rs = ps.executeQuery();
          engtable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        jButton1.setText("ENGLAND PLAYER LIST");
        getContentPane().add(jButton1);
        jButton1.setBounds(110, 30, 340, 50);
        ...
        engtable.setBackground(new java.awt.Color(204, 255, 204));
        ...
        jScrollPane1.setViewportView(engtable);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(30, 280, 520, 230);
        ...
        searchbox.setBounds(790, 380, 90, 40);
        ...
        jLabel2.setBounds(190, 130, 80, 30);
        ...
        jLabel3.setBounds(330, 130, 80, 30);
        ...
        jLabel4.setBounds(470, 130, 70, 30);
        ...
        jLabel8.setBounds(70, 130, 70, 30);
        ...
        jButton3.setBounds(650, 310, 110, 40);
        ...
        jButton5.setBounds(650, 190, 110, 40);
        ...
        jButton6.setBounds(650, 250, 110, 40);
        ...
        jButton7.setBounds(820, 20, 90, 40);

        jLabel1.setBackground(new java.awt.Color(255, 204, 0));
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fahim S\\Desktop\\JAVA\\ICC Pro\\205037.jpg")); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-140, 0, 1100, 910);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
      ...
      try{
          ...
          s="Insert into england values('"+a+"','"+b+"','"+c+"','"+d+"')";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
      ...
      String r= deletebox.getText();
          ...
          s="Delete from england where rank='"+r+"'";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      String u = updatebox.getText();
          s="update england set Name='"+a+"',Country='"+b+"',Rating='"+c+"',Rank='"+d+"'  where Rank='"+u+"'";
          ps=conn.prepareStatement(s);
          ps.executeUpdate();
          //conn.commit();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eng.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable engtable;
