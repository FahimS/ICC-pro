 ...
 * @author Fahim S
 */
public class nuz extends javax.swing.JFrame {
    Connection conn =  null;
    ResultSet rs=null;
     PreparedStatement ps=null;
    /**
     * Creates new form nuz
     */
    public nuz() {
        initComponents();
    ...
    private void Table()
    {
         try{
          ...
          String s= "select * from newzeland ";
          ps=conn.prepareStatement(s);
         rs = ps.executeQuery();
          nuztable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        nuztable = new javax.swing.JTable();
        ...
        jButton1.setText("NEWZELAND PLAYER LIST");
        getContentPane().add(jButton1);
        jButton1.setBounds(110, 20, 380, 50);
        ...
        nuztable.setBackground(new java.awt.Color(204, 255, 204));
        nuztable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(nuztable);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(30, 270, 540, 230);
        ...
        jButton3.setBounds(640, 250, 110, 40);
        ...
        jButton5.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fahim S\\Desktop\\JAVA\\ICC Pro\\A CLEAN.png")); // NOI18N
        ...
        jButton7.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fahim S\\Desktop\\JAVA\\ICC Pro\\A SEARCH.png")); // NOI18N
        ...
        name1.setBounds(50, 190, 110, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 204, 0));
        jLabel2.setText("Name");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(80, 130, 80, 40);
        ...
        jLabel4.setBounds(340, 130, 80, 40);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 204, 0));
        jLabel5.setText("Rank");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(480, 130, 80, 40);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fahim S\\Desktop\\JAVA\\ICC Pro\\nz.jpg")); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-20, 0, 1100, 550);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
      ...
      try{
          ...
          s="Insert into newzeland values('"+a+"','"+b+"','"+c+"','"+d+"')";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      String r= deletebox.getText();
          ...
          s="Delete from newzeland where rank='"+r+"'";
          ps=conn.prepareStatement(s);
          ps.execute();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
      ...
      String u = updatebox.getText();
          s="update newzeland set Name='"+a+"',Country='"+b+"',Rating='"+c+"',Rank='"+d+"'  where Rank='"+u+"'";
          ps=conn.prepareStatement(s);
          ps.executeUpdate();
          //conn.commit();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nuz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable nuztable;
